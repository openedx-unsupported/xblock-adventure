...
EXTRACTED_DJANGOJS := $(EXTRACT_DIR)/textjs.po
...
extract_translations: ## extract strings to be translated, outputting .po files
	...
	if [ -f "$(EXTRACTED_DJANGOJS_PARTIAL)" ]; then mv $(EXTRACTED_DJANGOJS_PARTIAL) $(EXTRACTED_DJANGOJS); fi
	rm -f $(EXTRACTED_DJANGO_PARTIAL)
	rm -f $(EXTRACTED_DJANGOJS_PARTIAL)
